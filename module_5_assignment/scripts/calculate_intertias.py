...
class InertialCalculator(object):
    ...
    def calculate_box_inertia(self, m, w, d, h):
        ...
        print(
            f'BOX ixx="{Iw}" ixy="0.0" ixz="0.0" iyy="{Id}" iyz="0.0" izz="{Ih}"'
        )

    def calculate_sphere_inertia(self, m, r):
        I = (2 * m * pow(r, 2)) / 5.0
        print(
            f'SPHERE ixx="{I}" ixy="0.0" ixz="0.0" iyy="{I}" iyz="0.0" izz="{I}"'
        )
    ...
    def calculate_cylinder_inertia(self, m, r, h):
        ...
        Iz = (m * pow(r, 2)) / 2.0
        print(
            f'CYLINDER ixx="{Ix}" ixy="0.0" ixz="0.0" iyy="{Iy}" iyz="0.0" izz="{Iz}"'
        )
